...
<body>
    <div class="row max-width">
        ...
        <div class="col-md-10 nav-content">
            ...
            <!-- Navbar -->
            <nav class="navbar">
                <label class="navbar-brand">Settings / Position / Update</label>
                <div class="dropdown">
            ...
            <div class="column maintain-paddings">
                <div class="card main-card">
                    <div class="row more-top-margin">
                        ...
                        <div class="col-md-4">
                            <a href="./" class="btn btn-primary btn-small">View Position</a>
                        </div>
                    </div>
                </div>
                <div class="card">
                    <div class="create-form">
                        ...
                        <form method="POST" action="../../core/services/position-service.php">
                            <?php
                                $id = $_SESSION['positionUpdateId'];
                                $result = getPosition($conn, $id);
                            ...
                            <div class="row extra-row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="form-control" name="pname" required id="pname"
                                        placeholder="Software Engineer" value="<?php echo $row["name"];?>">
                                </div>
                                

                                <div class="col-md-2 top-margin">
                                    <input type="submit" class="btn btn-success" value="Update" name="btnUpdatePosition">
                                </div>
                                <div class="col-md-2 top-margin">
