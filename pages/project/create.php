...
<body>
    <div class="row max-width">
        ...
        <div class="col-md-10 nav-content">
            ...
            <!-- Navbar -->
            <nav class="navbar">
                <label class="navbar-brand">Project / Create</label>
                <div class="dropdown">
                        ...
                        <form method="POST" action="../../core/services/project-service.php">
                            <div class="row extra-row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" name="prname" class="form-control" required id="prname"
                                        placeholder="ABC Project">
                                </div>
                                <div class="col-md-2 top-margin">
                                    <input type="submit" class="btn btn-success" value="Save" name="btnSaveProject">
                                </div>
                                <div class="col-md-2 top-margin">
